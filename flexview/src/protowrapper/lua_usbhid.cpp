...
LQUsbHid lqusbhid()
{
    ...
    .def("readData", (QByteArray (QUsbHid::*)())&QUsbHid::readData)
    ...
    .def("getFeature", (QByteArray(QUsbHid::*)(bool*))&QUsbHid::getFeature, pure_out_value(_2))
    ...
    .def("getInputReport", (QByteArray(QUsbHid::*)(bool*))&QUsbHid::getInputReport, pure_out_value(_2))
