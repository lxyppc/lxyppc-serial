...
template<>
void table_init_general<QAbstractSlider>(const luabind::argument & arg, const object& obj)
{
...
{
    return
    myclass_<QAbstractSlider,QWidget>("QAbstractSlider",lqas_set_map)
    .def(constructor<>())
    ...
    .property("invertedAppearance", &QAbstractSlider::invertedAppearance, &QAbstractSlider::setInvertedAppearance)
    .property("invertedControls", &QAbstractSlider::invertedControls, &QAbstractSlider::setInvertedControls)
    .property("maximum", &QAbstractSlider::maximum, &QAbstractSlider::setMaximum)
    .property("minimum", &QAbstractSlider::minimum, &QAbstractSlider::setMinimum)
    ...
    .property("orientation", QAbstractSlider_orientation, QAbstractSlider_setOrientation)
    .property("pageStep", &QAbstractSlider::pageStep,& QAbstractSlider::setPageStep)
    .property("singleStep", &QAbstractSlider::singleStep, &QAbstractSlider::setSingleStep)
    .property("sliderPosition", &QAbstractSlider::sliderPosition, &QAbstractSlider::setSliderPosition)
    .property("sliderDown", &QAbstractSlider::isSliderDown, &QAbstractSlider::setSliderDown)
    .property("tracking", &QAbstractSlider::hasTracking, &QAbstractSlider::setTracking)
...
template<>
void table_init_general<QSlider>(const luabind::argument & arg, const object& obj)
{
...
{
    return
    myclass_<QSlider,QAbstractSlider>("QSlider")
    .def(constructor<>())
    .def(constructor<QWidget*>())
    ...
    .property("tickInterval", &QSlider::tickInterval, &QSlider::setTickInterval)
...
template<>
void table_init_general<QScrollBar>(const luabind::argument & arg, const object& obj)
{
...
{
    return
    myclass_<QScrollBar,QAbstractSlider>("QScrollBar",lqscroll_set_map)
    .def(constructor<>())
    .def(constructor<QWidget*>())
    .def(constructor<Qt::Orientation, QWidget*>())
    .def(constructor<Qt::Orientation>())
...
template<>
void table_init_general<QDial>(const luabind::argument & arg, const object& obj)
{
...
{
    return
    myclass_<QDial,QAbstractSlider>("QDial",lqdial_set_map)
    .def(constructor<>())
    .def(constructor<QWidget*>())
    ...
    .property("notchesVisible", &QDial::notchesVisible, &QDial::setNotchesVisible)
...
template<>
void table_init_general<QProgressBar>(const luabind::argument & arg, const object& obj)
{
...
{
    return
    myclass_<QProgressBar,QWidget>("QProgressBar",lqprogressbar_set_map)
    .def(constructor<>())
    .def(constructor<QWidget*>())
    ...
    .property("orientation", QProgressBar_orientation, QProgressBar_setOrientation)
    .property("text", &QProgressBar::text)
    .property("textDirection", QProgressBar_textDirection, QProgressBar_setTextDirection)
    .property("textVisible", &QProgressBar::isTextVisible, &QProgressBar::setTextVisible)
...
QProgressDialog* lqprogressdialog_init(QProgressDialog* widget, const object& table)
{
...
template<>
void table_init_general<QProgressDialog>(const luabind::argument & arg, const object& obj)
{
...
{
    return
    myclass_<QProgressDialog,QDialog>("QProgressDialog",lqprogressdlg_set_map)
    .def(constructor<>())
    .def(constructor<QWidget*>())
    .def(constructor<QWidget*,Qt::WindowFlags>())
    .def(constructor<const QString&,const QString&,int,int,QWidget*,Qt::WindowFlags>())
    ...
    .property("autoClose", &QProgressDialog::autoClose, &QProgressDialog::setAutoClose)
    .property("autoReset", &QProgressDialog::autoReset, &QProgressDialog::setAutoReset)
    .property("labelText", &QProgressDialog::labelText, &QProgressDialog::setLabelText)
    .property("maximum", &QProgressDialog::maximum, &QProgressDialog::setMaximum)
    .property("max", &QProgressDialog::maximum, &QProgressDialog::setMaximum)
    .property("minimum", &QProgressDialog::minimum, &QProgressDialog::setMinimum)
    .property("min", &QProgressDialog::minimum, &QProgressDialog::setMinimum)
    .property("minimumDuration", &QProgressDialog::minimumDuration, &QProgressDialog::setMinimumDuration)
    .property("minDuration", &QProgressDialog::minimumDuration, &QProgressDialog::setMinimumDuration)
