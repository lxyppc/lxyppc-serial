...
template<>
void table_init_general<QStackedLayout>(const luabind::argument & arg, const object& obj)
{
...
{
    return
    myclass_<QStackedLayout, QLayout>("QStackedLayout",lqstacklayout_set_map)
        .def(constructor<>())
        .def(constructor<QWidget*>())
        ...
        .def("widget", (QWidget *(QStackedLayout::*)(int) const)&QStackedLayout::widget)

        .property("currentIndex", &QStackedLayout::currentIndex, &QStackedLayout::setCurrentIndex)
        .property("stackingMode", QStackedLayout_stackingMode, QStackedLayout_setStackingMode)
        .sig_prop(lqstatckedlayout,currentChanged)
        .sig_prop(lqstatckedlayout,widgetRemoved)
        .class_<QStackedLayout, QLayout>::property("currentWidget", &QStackedLayout::currentWidget, &QStackedLayout::setCurrentWidget)
    ;
}
...
template<>
void table_init_general<QGridLayout>(const luabind::argument & arg, const object& obj)
{
    lqgridlayout_init(construct<QGridLayout>(arg), obj);
}

void lqgridlayout_addLayout1(QGridLayout*  w, QLayout* l, int r, int c){ w->addLayout(l,r,c);}
void lqgridlayout_addLayout2(QGridLayout*  w, QLayout* l, int r, int c, int rs, int cs){ w->addLayout(l,r,c,rs,cs);}
...
{
    return
    myclass_<QGridLayout, QLayout>("QGridLayout",lqgridlayout_set_map)
    .def(constructor<>())
    .def(constructor<QWidget*>())
    .def("__call", lqgridlayout_init)
    .def("__init", table_init_general<QGridLayout>)
    .def("addLayout", (void (QGridLayout::*)(QLayout*,int,int,Qt::Alignment))&QGridLayout::addLayout)
    .def("addLayout", (void (QGridLayout::*)(QLayout*,int,int,int,int,Qt::Alignment))&QGridLayout::addLayout)
    .def("addWidget", (void (QGridLayout::*)(QWidget*,int,int,Qt::Alignment))&QGridLayout::addWidget)
    .def("addWidget", (void (QGridLayout::*)(QWidget*,int,int,int,int,Qt::Alignment))&QGridLayout::addWidget)
    ...
    .property("horizontalSpacing", &QGridLayout::horizontalSpacing, &QGridLayout::setHorizontalSpacing)
                ...
                if(label && field){
                    if(type(label) == LUA_TSTRING){
                        ...
                        if(is_class<QLayout>(field)){
                            ...
                            QWidget* w = 0;
                            try{ w = object_cast<QWidget*>(field);}
                            catch(...){}
                            if(w){
                                widget->addRow(l, w);
                            }
...
template<>
void table_init_general<QFormLayout>(const luabind::argument & arg, const object& obj)
{
...
{
    return
    myclass_<QFormLayout, QLayout>("QFormLayout",lqformlayout_set_map)
    .def(constructor<>())
    .def(constructor<QWidget*>())
    .def("__call", lqformlayout_init)
    .def("__init", table_init_general<QFormLayout>)
    .def("addRow", (void(QFormLayout::*)(QWidget*,QWidget*))&QFormLayout::addRow)
    .def("addRow", (void(QFormLayout::*)(QWidget*,QLayout*))&QFormLayout::addRow)
    .def("addRow", (void(QFormLayout::*)(const QString&,QWidget*))&QFormLayout::addRow)
    .def("addRow", (void(QFormLayout::*)(const QString&,QLayout*))&QFormLayout::addRow)
    .def("addRow", (void(QFormLayout::*)(QWidget*))&QFormLayout::addRow)
    .def("addRow", (void(QFormLayout::*)(QLayout*))&QFormLayout::addRow)
    .def("insertRow", (void(QFormLayout::*)(int,QWidget*,QWidget*))&QFormLayout::insertRow)
    .def("insertRow", (void(QFormLayout::*)(int,QWidget*,QLayout*))&QFormLayout::insertRow)
    .def("insertRow", (void(QFormLayout::*)(int,const QString&,QWidget*))&QFormLayout::insertRow)
    .def("insertRow", (void(QFormLayout::*)(int,const QString&,QLayout*))&QFormLayout::insertRow)
    .def("insertRow", (void(QFormLayout::*)(int,QWidget*))&QFormLayout::insertRow)
    .def("insertRow", (void(QFormLayout::*)(int,QLayout*))&QFormLayout::insertRow)
    .def("setItem", &QFormLayout::setWidget)
    .def("labelForField", (QWidget*(QFormLayout::*)(QWidget*) const)&QFormLayout::labelForField)
    .def("labelForField", (QWidget*(QFormLayout::*)(QLayout*) const)&QFormLayout::labelForField)
