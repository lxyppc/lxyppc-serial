...
{
    return X_MALLOC(NULL, sizeof( md2_context ) );
}
...
{
    return X_MALLOC(NULL, sizeof( md4_context ) );
}
...
{
    return X_MALLOC(NULL, sizeof( md5_context ) );
}
...
{
    return X_MALLOC(NULL, sizeof( sha1_context ) );
}
...
{
    return X_MALLOC(NULL, sizeof( sha2_context ) );
}
...
{
    return X_MALLOC(NULL, sizeof( sha4_context ) );
}
